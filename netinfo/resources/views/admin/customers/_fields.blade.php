...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <div>
        ...
        <select name="package_id" required class="mt-1.5 block w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2 text-sm text-slate-900 focus:border-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900/10 transition-all">
    ...
    <div>
        ...
        <select name="node_id" required class="mt-1.5 block w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2 font-mono text-sm text-slate-900 focus:border-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900/10 transition-all">
            @foreach ($nodes as $n)
...
<div>
    ...
    <textarea name="address" rows="2" required placeholder="Alamat lengkap instalasi..."
        class="mt-1.5 block w-full resize-none rounded-lg border border-slate-200 bg-white px-3.5 py-2 text-sm text-slate-900 focus:border-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900/10 transition-all">{{ $oldData['address'] ?? '' }}</textarea>
...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
    ...
    <div>
        ...
        <input type="date" name="installation_date" required value="{{ $oldData['installation_date'] ?? now()->toDateString() }}"
            class="mt-1.5 block w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2 text-sm text-slate-700 focus:border-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900/10 transition-all">
    </div>
    <div>
        <label class="block text-sm font-medium text-slate-700">Status</label>
        <select name="status" class="mt-1.5 block w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2 text-sm text-slate-700 capitalize focus:border-slate-900 focus:outline-none focus:ring-2 focus:ring-slate-900/10 transition-all">
